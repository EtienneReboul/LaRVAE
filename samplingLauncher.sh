...
python sampling.py --model checkpoints/100_100_NoAdj_no_hex_new_weights.ckpt --numsample 10000 --mol_encoding selfies --hex --savename samples/sampled_selfies_no_hex.csv 
